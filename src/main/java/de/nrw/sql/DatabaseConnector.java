...
import de.nrw.datenstrukturen.Queue;
 ...
 * </p>
 * <p>
 * Ein Objekt der Klasse DatabaseConnector ermoeglicht die Abfrage und Manipulation einer SQLite-Datenbank. Beim
 * Erzeugen des Objekts wird eine Datenbankverbindung aufgebaut, so dass anschließend SQL-Anweisungen an diese Datenbank
 * gerichtet werden koennen.
 * </p>
 *
...
public class DatabaseConnector
{
	...
	/**
	 * Ein Objekt vom Typ DatabaseConnector wird erstellt, und eine Verbindung zur Datenbank wird aufgebaut. Mit den
	 * Parametern pIP und pPort werden die IP-Adresse und die Port-Nummer uebergeben, unter denen die Datenbank mit
	 * Namen pDatabase zu erreichen ist. Mit den Parametern pUsername und pPassword werden Benutzername und Passwort
	 * fuer die Datenbank uebergeben.
	 */
	public DatabaseConnector(String pIP, int pPort, String pDatabase, String pUsername, String pPassword)
	{
		//Eine Impementierung dieser Schnittstelle fuer SQLite ignoriert pID und pPort, da die Datenbank immer lokal
		// ist.
	...
	/**
	 * Der Auftrag schickt den im Parameter pSQLStatement enthaltenen SQL-Befehl an die Datenbank ab. Handelt es sich
	 * bei pSQLStatement um einen SQL-Befehl, der eine Ergebnismenge liefert, so kann dieses Ergebnis anschließend mit
	 * der Methode getCurrentQueryResult abgerufen werden.
	 */
	...
	/**
	 * Die Anfrage liefert das Ergebnis des letzten mit der Methode executeStatement an die Datenbank geschickten
	 * SQL-Befehls als Ob-jekt vom Typ QueryResult zurueck. Wurde bisher kein SQL-Befehl abgeschickt oder ergab der
	 * letzte Aufruf von executeStatement keine Ergebnismenge (z.B. bei einem INSERT-Befehl oder einem Syntaxfehler) ,
